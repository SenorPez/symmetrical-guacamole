...
import com.senorpez.avt.shipdesigner.systems.structural.Hull;
...
class HullTest {
    ...
    void getCostPerSpace() {
        ...
        int expectedValue = 1;
        Assertions.assertEquals(expectedValue, instance.getCostPerSpace());
    }
    ...
    void getActualSpacesUsed() {
        int expectedValue = 0;
        Assertions.assertEquals(expectedValue, instance.getActualSpacesUsed());
    }
    ...
    void getBaseCost() {
        ...
        Assertions.assertEquals(expectedValue, instance.getBaseCost());
    }
    ...
    void getEnhancedCost() {
        ...
        when(ship.getShape()).thenReturn(Shape.ELLIPSOID);
        int expectedValue = 55;
        Assertions.assertEquals(expectedValue, instance.getEnhancedCost());
