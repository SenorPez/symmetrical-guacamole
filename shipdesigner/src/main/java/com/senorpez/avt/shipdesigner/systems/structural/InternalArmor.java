...
public class InternalArmor extends System {
    ...
    @Override
    public InternalArmor setShrinkEnhancement(int shrinkEnhancement) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public InternalArmor setProductionLevel(ProductionLevel productionLevel) {
